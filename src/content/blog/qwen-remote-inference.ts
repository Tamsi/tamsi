...
git-mentor analyze --user Tamsi`,
        ...
        {
          type: 'paragraph',
          text: 'Two complementary stacks: vLLM on AWS for the “full throttle” agent (free inference tokens), Ollama locally for git-mentor. AWS setup took an afternoon; the real win is mental and economic. Cursor stays my interface; the heavy brain runs on my GPU in the cloud, the light one on the laptop. Follow-up: Qwen 3.8 27B on MLX on the M1 — /blog/qwen-3-8-27b-local-mlx.',
        },
      ],
    },
  },
